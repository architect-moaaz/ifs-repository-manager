...
@ApplicationScoped
public class FilesByAppRepository implements PanacheMongoRepository<FilesByApp>, ParentRepository<FilesByApp>{

    @Override
    public void saveModel(FilesByApp object) {
        persist(object);
    }

    @Override
    public void updateModel(FilesByApp object) {
        update(object);
    }

    @Override
    public FilesByApp modelWithFilters(Map<String, Object> params) {
    ...
    @Override
    public List<FilesByApp> listOfModelsWithFilters(Map<String, Object> params) {
        BasicDBObject query = new BasicDBObject();
        for (Map.Entry<String, Object> entry : params.entrySet()) {
            String fieldKey = entry.getKey();
            Object fieldValue = entry.getValue();
    ...
    @Override
    public void deleteModel(FilesByApp object) {
          delete(object);
    }
    ...
    @Override
    public List<FilesByApp> listOfModelsWithFiltersPaginated(Map<String, Object> params, List<Map<String, String>> sortCriteria, int page, int size) {
        Sort sort = Sort.by();
        BasicDBObject query = new BasicDBObject();
