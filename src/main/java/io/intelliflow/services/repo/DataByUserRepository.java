...
@ApplicationScoped
public class DataByUserRepository implements PanacheMongoRepository<DataByUser>, ParentRepository<DataByUser>{

    @Override
    public void saveModel(DataByUser dataByUser) {
        persist(dataByUser);
    }

    @Override
    public void updateModel(DataByUser dataByUser) {
        update(dataByUser);
    }

    @Override
    public DataByUser modelWithFilters(Map<String, Object> params) {
    ...
    @Override
    public List<DataByUser> listOfModelsWithFilters(Map<String, Object> params) {
        BasicDBObject query = new BasicDBObject();
        for (Map.Entry<String, Object> entry : params.entrySet()) {
            String fieldKey = entry.getKey();
            Object fieldValue = entry.getValue();
    ...
    @Override
    public void deleteModel(DataByUser object) {
           delete(object);
    }
    ...
    @Override
    public List<DataByUser> listOfModelsWithFiltersPaginated(Map<String, Object> params, List<Map<String, String>> sortCriteria, int page, int size) {
        Sort sort = Sort.by();
        BasicDBObject query = new BasicDBObject();
